...
pub trait Call_Activate: VarlinkCallError {
    fn reply(&mut self, r#message: String, r#done: bool) -> varlink::Result<()> {
        self.reply_struct(Activate_Reply { r#message, r#done }.into())
    }
}
...
pub trait Call_AddFromManifest: VarlinkCallError {
    fn reply(&mut self, r#message: String, r#done: bool) -> varlink::Result<()> {
        self.reply_struct(AddFromManifest_Reply { r#message, r#done }.into())
    }
}
...
pub trait Call_AddFromUrl: VarlinkCallError {
    fn reply(&mut self, r#message: String, r#done: bool) -> varlink::Result<()> {
        self.reply_struct(AddFromUrl_Reply { r#message, r#done }.into())
    }
}
